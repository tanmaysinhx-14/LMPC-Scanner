              ...
              <form method="POST" action="./index.php" novalidate>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-body-tertiary"><i class="fas fa-user text-secondary"></i></span>
                    <input id="registerFullName" name="fullName" type="text" class="form-control" placeholder="Enter your full name" required autocomplete="name" value="<?php echo isset($_POST['fullName']) ? htmlspecialchars($_POST['fullName']) : ''; ?>">
                  </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-body-tertiary"><i class="fas fa-envelope text-secondary"></i></span>
                    <input id="registerEmail" name="email" type="email" class="form-control" placeholder="Enter your email address" required autocomplete="email" value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>">
                  </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-body-tertiary"><i class="fas fa-phone text-secondary"></i></span>
                    <input id="registerPhone" name="phone" type="tel" class="form-control" placeholder="Enter your phone number" required autocomplete="tel" value="<?php echo isset($_POST['phone']) ? htmlspecialchars($_POST['phone']) : ''; ?>">
                  </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input id="registerPassword" name="password" type="password" class="form-control" placeholder="Create a strong password" required minlength="8" autocomplete="new-password">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text bg-body-tertiary"><i class="fas fa-check-circle text-secondary"></i></span>
                    <input id="registerConfirmPassword" name="confirmPassword" type="password" class="form-control" placeholder="Confirm your password" required autocomplete="new-password">
                  </div>
                ...
                <div class="mb-4">
                  <div class="form-check">
                    <input id="termsCheckbox" name="termsAccepted" class="form-check-input" type="checkbox" <?php echo isset($_POST['termsAccepted']) ? 'checked' : ''; ?> required>
                ...
                <div class="d-flex align-items-center mb-3">
                  ...
                  <span class="px-3 text-secondary text-uppercase small fw-medium">or continue with</span>
                  <hr class="flex-grow-1">
                </div>

                <!-- Social -->
                <button type="button" class="btn btn-outline-dark w-100 py-2 mb-4">
