...
<head>
  ...
  <style>
    ...
    .feed-navbar { position: sticky; top: 0; z-index: 1030; padding: .72rem 0; border-bottom: 1px solid rgba(255,255,255,.12); background: rgba(22,33,63,.96); box-shadow: 0 10px 28px rgba(22,33,63,.16); backdrop-filter: blur(18px); }
    .feed-brand { display: inline-flex; align-items: center; gap: .6rem; color: #fff; font-size: 1.16rem; font-weight: 800; letter-spacing: -.04em; text-decoration: none; }
    .feed-brand:hover { color: #d9fff9; }
    .feed-brand-icon { display: inline-flex; width: 2.2rem; height: 2.2rem; align-items: center; justify-content: center; border-radius: .7rem; color: #fff; background: linear-gradient(135deg,#4255c7,#0f9f8f); box-shadow: 0 7px 16px rgba(15,159,143,.22); }
    .feed-navbar .btn-outline-secondary { border-color: rgba(255,255,255,.22); color: #e4eaff; background: rgba(255,255,255,.05); }
    .feed-navbar .btn-outline-secondary:hover { color: #fff; border-color: rgba(255,255,255,.45); background: rgba(255,255,255,.12); }
    .feed-navbar .btn-primary { border-color: #51c7b6; color: #102b3c; background: #7de0d1; box-shadow: none; }
    .feed-layout { display: grid; grid-template-columns: minmax(0, 1fr) 360px; gap: 1.6rem; max-width: 1320px; margin: 0 auto; padding: 1.8rem 1.2rem 3rem; }
    .feed-column { min-width: 0; }
    .feed-heading { display: flex; align-items: end; justify-content: space-between; gap: 1rem; margin-bottom: 1rem; padding: 1.05rem 1.15rem; border: 1px solid rgba(66,85,199,.14); border-radius: 1.15rem; background: rgba(255,255,255,.74); box-shadow: 0 12px 30px rgba(22,33,63,.05); }
    ...
    .feed-priority-note { display: inline-flex; align-items: center; gap: .42rem; padding: .48rem .68rem; border: 1px solid rgba(15,159,143,.18); border-radius: .7rem; color: #087568; background: #e7faf6; font-size: .7rem; font-weight: 750; white-space: nowrap; }
    .feed-priority-note i { color: var(--feed-teal); }
    .feed-filter-panel { display: grid; grid-template-columns: minmax(0,1.4fr) repeat(2,minmax(130px,.7fr)) minmax(120px,.6fr) auto; gap: .5rem; padding: .7rem; margin-bottom: .75rem; border: 1px solid var(--feed-line); border-radius: 1rem; background: rgba(255,255,255,.86); box-shadow: 0 8px 22px rgba(22,33,63,.04); }
    ...
    .feed-post { position: relative; margin-bottom: .9rem; padding: 1.15rem 1.25rem 1.05rem 1.45rem; border: 1px solid var(--feed-line); border-radius: 1.15rem; background: rgba(255,255,255,.92); box-shadow: 0 7px 22px rgba(22,33,63,.045); transition: border-color .2s ease, box-shadow .2s ease, transform .2s ease; }
    .feed-post::before { content: ''; position: absolute; top: 1.05rem; bottom: 1.05rem; left: .55rem; width: .22rem; border-radius: 999px; background: linear-gradient(180deg, var(--feed-purple), var(--feed-teal)); opacity: .82; }
    .feed-post:hover { border-color: #bcc7e7; box-shadow: 0 16px 34px rgba(22,33,63,.1); transform: translateY(-2px); }
    ...
    .post-title { display: block; margin: .25rem 0 .45rem; color: var(--feed-ink); font-size: 1.08rem; font-weight: 800; line-height: 1.38; letter-spacing: -.025em; text-decoration: none; }
    ...
    .community-signal { display: inline-flex; align-items: center; gap: .35rem; margin: -.35rem 0 .7rem; padding: .35rem .55rem; border-radius: .55rem; color: #087568; background: #e7faf6; font-size: .72rem; font-weight: 700; }
    ...
    .post-actions { display: flex; flex-wrap: wrap; align-items: center; gap: .15rem; padding-top: .65rem; border-top: 1px solid #e9edf4; }
    ...
    .side-card { margin-bottom: 1rem; overflow: hidden; border: 1px solid var(--feed-line); border-radius: 1.15rem; background: rgba(255,255,255,.9); box-shadow: 0 10px 26px rgba(22,33,63,.06); }
    ...
    @media (max-width: 520px) { .feed-navbar .container { padding: 0 .75rem; } .feed-navbar .nav-copy { display: none; } .feed-layout { padding-inline: .55rem; } .feed-heading { align-items: flex-start; flex-direction: column; } .feed-heading > div:last-child { width: 100%; justify-content: space-between; } .feed-filter-panel { grid-template-columns: 1fr; } .feed-post { padding: .9rem .9rem .9rem 1.15rem; } .post-score { width: 100%; margin-left: 0; padding-left: .7rem; } #issueMap { height: 260px; } }
  </style>
</head>
<body>
  ...
  <main class="feed-layout">
    <section class="feed-column">
      <div class="feed-heading"><div><h1>Community Feed</h1><p>Grouped posts turn nearby reports into one shared civic story.</p></div><div class="d-flex align-items-center gap-3"><span class="feed-priority-note"><i class="fas fa-ranking-star"></i>Live civic priority</span><span class="small text-muted"><?= (int) ($feed['pagination']['total'] ?? 0) ?> issues</span></div></div>
