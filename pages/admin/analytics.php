...
<body class="app-body">
  ...
  <script>
    fetch('../../api/stats/analytics.php').then(response => response.json().then(result => ({response, result}))).then(({response, result}) => {
