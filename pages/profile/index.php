...
$dashboardPath = civicDashboardForRole((string) ($viewer['role'] ?? 'citizen'));
?>
<?php require_once CIVICCONNECT_ROOT . '/components/header.php'; ?>
<body class="app-body">
  <main class="container py-4 py-lg-5">
    <div class="d-flex align-items-center justify-content-between gap-3 mb-4"><a href="<?= $e($dashboardPath) ?>" class="text-decoration-none fw-bold"><i class="fas fa-arrow-left me-2"></i>Back to dashboard</a><a href="<?= $e(civicRoute('change_password')) ?>" class="btn btn-sm btn-outline-primary"><i class="fas fa-lock me-1"></i>Change password</a></div>
