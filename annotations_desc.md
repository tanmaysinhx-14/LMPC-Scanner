...
(Text Patterns)
"Product Category: Plain", "Chocolate." -> not iinline

4. manufacturer_region
(Text Patterns)
"Manufactured By: Company Pvt. Ltd. + Address + Pincode + District/State + FSSAI License Number" -> Not necessarily inline
"For packaging location refer to the last alphabet of the batch code: ... multiple addresses after this"
